...
#step2 Write a function that can take in a player input and assign their marker as 'X' or 'O'.
...
#Step 6: Write a function that asks for a player's next position (as a number 1-9) and
...
def player_choice(board):
    ...
    return position
#Step 7: Write a function that asks the player if they want to play again and returns a boolean True if they do want to play again.

def replay():

    return input('Do you want to play again? Enter Yes or No: ').lower().startswith('y')

#step8: Here comes the hard part! Use while loops and the functions you've made to run the game!
